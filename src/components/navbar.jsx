...
function Navbar() {
    ...
    return (
        <>
            {/* Top Navbar */}
            <div className="flex flex-wrap items-center gap-12 justify-center p-4 border-b border-gray-200 w-full">
                {/* Logo */}
                ...
                <div className="flex gap-6 items-center">
                    {[
                        { icon: <CgProfile className="text-2xl" />, label: "Profile", path: "#" },
                        { icon: <MdMessage className="text-2xl" />, label: "Message", path: "#" },
                        { icon: <FaHeart className="text-2xl" />, label: "Orders", path: "#" },
                        { icon: <AiOutlineShoppingCart className="text-2xl" />, label: "My Cart", path: "" },
                    ].map((item, idx) => (
                        <div key={idx} className="flex flex-col gap-1 items-start text-xs text-gray-400 hover:text-blue-500 transition">
                            {item.icon}
                            <a href='#'>{item.label}</a>
                        </div>
                    ))}
            ...
            {/* Bottom Menu */}
            <div className="flex justify-center items-center flex-wrap gap-28 text-black px-6 py-3 border-b border-gray-200 w-full">
